...
Two very basic convenience functions are available. First, `doge_summarise()` presents basic statistical information about the dataset downloaded from doge.gov/savings. Second, `fpds_stats` lists very basic information about the number of rows downloaded from FPDS. 
```{r}
doge_summarize(df)
fpds_stats(f)
```
